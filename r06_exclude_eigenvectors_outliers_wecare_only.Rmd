---
title: "exclude_eigenvectors_outliers"
...
- Exclude eigenvectors outliers: P5_E09 and P6_D05  
...
Input data:  238,958 vars x 480 cases (245 UBC and 235 CBC)  
Output data: 237,258 vars x 478 cases (245 UBC and 233 CBC)  
of them:  
...
#base_folder="/analysis/mtgroup_share/users/alexey/wecare_only_08.17"
load(paste(base_folder, "results", "r05_calculate_hw_and_egenvectors_wecare_only.RData", sep="/"))
...
# Prepare empty matrix for eigenvectors to add
...
# Summaryse cases filter
summary(as.factor(wecare_wes_phenotypes.df$filter))

# Write down the updated phenotype file
write.table(wecare_wes_phenotypes.df, file=paste(base_folder, "results", "r06_wecare_phenotypes_final.txt", sep="/"), quote=FALSE, sep="\t")
...
# Flag outliers
eig_outliers <- c("P6_D05", "P5_E09")
"eigenvectors_outlier" -> phenotypes.df[phenotypes.df$wes_id %in% eig_outliers, "filter"]
...
# remove_variants_with_uniform_genotypes_accross_remainig_samples
Remove 1,700 variants: 238,958 -> 237,258

```{r remove_variants_with_uniform_genotypes_accross_remainig_samples}
...
#base_folder="/analysis/mtgroup_share/users/alexey/wecare_only_08.17"
save.image(paste(base_folder, "results", "r06_exclude_eigenvectors_outliers_wecare_only.RData", sep="/"))
