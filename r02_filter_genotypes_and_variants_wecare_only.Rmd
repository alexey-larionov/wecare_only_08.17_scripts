...
Call rate 85% was set for consistency with missing_cutoff default value (0.15) in SKAT function  
...
Remove variants with call rate < 85% after the gemnotypes filtering:  
removes 45,214 (~13%) variants (343,824 -> 298,610)
...
sum(var.retained) # 298,610
1 - sum(var.retained)/nrow(gt.mx) # ~13%
...
Remove 51,156 variants: 298,610 -> 247,454  
Some of the removed variants were detected in NFE only  
